...
const Contact= () => {
  ...
  return (
    <div className="flex flex-col items-center w-full h-full p-8 relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 w-full max-w-6xl mt-4">
        {/* Office Location */}
        <div className="flex flex-col items-center text-center">
          <MapPin className="mb-4 text-green-500" size={36} />
          <span className="text-blue-950 text-lg font-bold">OFFICE LOCATION</span>
          <span className="text-md font-thin">Anachal, Idukki, Kerala 685565</span>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-sm w-full shadow-2xl transform transition-all duration-300 ease-in-out">
            ...
            <div className="flex items-center mb-6">
              ...
              <div className="ml-4">
                <h2 className="text-2xl font-bold text-green-600">Chat with us!</h2>
                <p className="text-gray-600">We're here to help.</p>
              </div>
            </div>
            <p className="text-gray-700 mb-6">
              Have a question or need assistance? Chat with our team on WhatsApp for quick and friendly support!
            </p>
            <a
